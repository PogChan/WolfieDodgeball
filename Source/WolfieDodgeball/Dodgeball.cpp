...
ADodgeball::ADodgeball()
{
	...
	if (!ProjectileMeshComponent)
	{
		...
		static ConstructorHelpers::FObjectFinder<UStaticMesh>Mesh(TEXT("StaticMesh'/Game/Dodgeball/sphere.sphere'"));
		if (Mesh.Succeeded())
		{
			ProjectileMeshComponent->SetStaticMesh(Mesh.Object);
		}

		static ConstructorHelpers::FObjectFinder<UMaterial>Material(TEXT("Material'/Game/Dodgeball/DodgeballMaterial.DodgeballMaterial'"));
